/****************************************************************************
** Meta object code from reading C++ file 'duthread.hpp'
**
...
#error "The header file 'duthread.hpp' doesn't include <QObject>."
...
void DuThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DuThread *_t = static_cast<DuThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DuThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DuThread::timeOut)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DuThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DuThread.data,
      qt_meta_data_DuThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DuThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DuThread.stringdata0))
        return static_cast<void*>(const_cast< DuThread*>(this));
